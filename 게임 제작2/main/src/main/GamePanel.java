...
public class GamePanel extends JPanel implements Runnable {
	 ...
	 * update() 메서드:
	 * 
	 * 기능: 게임의 상태를 업데이트 상세 설명: 게임이 플레이 상태일 때 플레이어와 모든 몬스터의 상태를 업데이트 각 몬스터와 플레이어 간의
	 * 충돌 여부를 검사하여 충돌 시 전투 상태로 전환
	 **/
	 ...
	 * 
	 * 기능: 충돌 발생 시 전투 상태로 전환하고 전투를 처리 상세 설명: 충돌이 발생하면 게임 상태를 전투 상태로 전환하고, 현재 재생 중인
	 * 음악을 정지한 후 전투 음악을 재생/ 그래픽 객체를 사용하여 전투 매니저를 통해 전투를 실행
	 **/
